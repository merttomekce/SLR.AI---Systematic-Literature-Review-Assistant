              ...
              <Card className="p-6 cursor-pointer group border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:scale-105 animate-in fade-in duration-500 relative overflow-hidden">
                ...
                <div className="space-y-4">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-blue-500/10 text-xs font-medium text-blue-600">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div className="rounded-md bg-muted/50 p-2">
                      ...
                      <p className="text-lg font-semibold text-foreground">{currentS1Run.stats.total}</p>
                    </div>
                    <div className="rounded-md bg-muted/50 p-2">
                      <p className="text-xs text-muted-foreground">Included</p>
                      <p className="text-lg font-semibold text-green-600">{currentS1Run.stats.included}</p>
                    </div>
                    <div className="rounded-md bg-muted/50 p-2">
                      <p className="text-xs text-muted-foreground">Excluded</p>
                      <p className="text-lg font-semibold text-red-600">{currentS1Run.stats.excluded}</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between text-xs">
                      ...
                      <span className="font-semibold text-foreground">{getS1RunProgress(currentS1Run)}%</span>
                    </div>
              ...
              <Card className="p-6 cursor-pointer group border-border hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:scale-105 animate-in fade-in duration-500 relative overflow-hidden">
                ...
                <div className="space-y-4">
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-1 px-2 py-1 rounded-full bg-green-500/10 text-xs font-medium text-green-600">
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div className="rounded-md bg-muted/50 p-2">
                      <p className="text-xs text-muted-foreground">Papers</p>
                      <p className="text-lg font-semibold text-foreground">{run.stats.total}</p>
                    </div>
                    <div className="rounded-md bg-muted/50 p-2">
                      <p className="text-xs text-muted-foreground">Included</p>
                      <p className="text-lg font-semibold text-green-600">{run.stats.included}</p>
                    </div>
                    <div className="rounded-md bg-muted/50 p-2">
                      <p className="text-xs text-muted-foreground">Excluded</p>
                      <p className="text-lg font-semibold text-red-600">{run.stats.excluded}</p>
                    </div>
                  </div>
                </div>
              </Card>
